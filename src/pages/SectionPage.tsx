...
import { fleetAgeStatistics, getSection, presentationSections } from '@/content/presentation'
  ...
  return (
    <SlideFrame section={section}>
      <div className="mx-auto flex min-h-[100svh] max-w-[90rem] flex-col px-6 pt-28 pb-24 sm:px-10">
        ...
        <div className="relative mt-8 min-h-[22rem] flex-1 border-y border-white/20" data-animate>
          <img
...
function ProjectsSlide({ section, index }: SlideProps) {
  const projects = [
    ...
    },
    {
      ...
      images: ['/media/operacion-evento-2023.avif', '/media/operacion-pasarela-sant-celoni.avif'],
    },
  ] as const
