    ...
    <section data-route-content>
      <div className="relative isolate min-h-[100svh] overflow-hidden bg-[#0b0b0c]">
        ...
        {!prefersReducedMotion ? (
          <div aria-hidden="true" className="absolute inset-x-0 top-20 z-10" data-animate>
          ...
          <div className="relative z-10 mt-auto max-w-3xl">
            ...
            >
              {[
                ...
                ['Flota propia', '86 vehículos para responder con medios propios.'],
                ...
                >
                  ...
                  <dd className="mt-1.5 text-xs leading-5 text-white/70">{label}</dd>
                </div>
              ))}
            </dl>
          </div>
